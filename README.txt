...
Milestones:
    ...
    Milestone 1: Get board needed for project. Initialize gyroscope to get x and y values.
        ...
        retrieved the x and y coordinates. This can be found in the l3gd20.c file Src/Helper.
	...
	Milestone 2: Create images (backgrounds with targets and ball) needed to display. Display layer 1
	    ...
	    Displaying on the individual layers is displayed as well as the other functions for the lcd in the lcd.c file
	    in Src/Helper.

	Milestone 3: Update ball position from gyroscope x and y data.

	    This also was a tricky bit. We were easily able to get the x and y data, however, it has a ton of noise. We made
	    some adjustments to the gyroscope high pass filter and set out own thresholds in main.c to try and minimize this.
	...
	Milestone 4: Trigger LED when target is met. Display winning screen.
        ...
        last, the led frequency frequency is increased. To accomplish this we use timers. The led helper functions can
